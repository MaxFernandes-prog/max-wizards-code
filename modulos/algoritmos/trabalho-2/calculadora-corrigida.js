...
A raiz quadrada de ${primNum} é ` +
    Math.sqrt(primNum) +
    `

O valor elevado de ${primNum} no expoente de ${segNum} é ` +
    Math.pow(primNum, segNum)
);
//alterado texto em expoente por erro inicial

//criando uma condição para que a fórmula de bhaskara funcione

const delta = b * b - 4 * a * c;

if (delta < 0) {
  console.log("Ops, parece que o seu delta é negativo");
} else {
